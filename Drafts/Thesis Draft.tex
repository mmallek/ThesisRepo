...
\toprule
\textbf{\begin{tabular}[c]{@{}l@{}}Land Cover \\ Abbreviation\end{tabular}} & \textbf{Land Cover Name}    & \textbf{\begin{tabular}[c]{@{}l@{}}Area \\ Core Only\\ (Hectares)\end{tabular}}  \\ \midrule
  							\textsc{meg\_m  }     & Mixed Evergreen - Mesic                      & 7,273  \\
\rowcolor[HTML]{CAD6BA}  	\textsc{meg\_x  }     & Mixed Evergreen - Xeric                      & 6,768  \\
     						\textsc{ocfw    }     & Oak-Conifer Forest and Woodland              & 23,729 \\
\rowcolor[HTML]{CAD6BA}		\textsc{ocfw\_u }     & \begin{tabular}[c]{@{}l@{}}Oak-Conifer Forest and \\ Woodland -  Ultramafic\end{tabular} & 1,060 \\
  							\textsc{rfr\_m  }     & Red Fir - Mesic                              & 8,563  	  \\
\rowcolor[HTML]{CAD6BA}		\textsc{rfr\_x  }     & Red Fir - Xeric                              & 7,493  	  \\
                    		\textsc{smc\_m  }     & Sierran Mixed Conifer - Mesic                & 57,853 	  \\
\rowcolor[HTML]{CAD6BA}  	\textsc{smc\_u  }     & Sierran Mixed Conifer - Ultramafic           & 4,124  	  \\
                     		\textsc{smc\_x  }     & Sierran Mixed Conifer - Xeric                & 52,198 	  \\
\end{tabular}
\end{table}
...
\subsection*{Landscape configuration}
We present pooled results for the six metrics in Figure~\ref{fig:fragland} because differences across future scenarios were minimal. The current landscape is completely departed from both the FRV and the HRV. Results across four of six metrics (area-weighted mean patch size, corea area, radius of gyration, and shape) show that the FRV is completely departed from the HRV as well. In terms of Contagion, the FRV is slightly departed from the HRV. For the Simpson's Evenness Index, the FRV is moderately departed from the HRV.\todo{I don't think there is a need to look at class-level dynamics, but we could. I haven't thought of a good question it would answer yet.}
