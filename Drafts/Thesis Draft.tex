...
For each of these six landscape metrics, the current landscape is well outside either SRV. The FRV is farther away from the current condition than the HRV for all of the area-weighted metrics. Patches during the simulated historical period were larger and had more core area than on the current landscape, and projected to be even larger with even more core area during the simulated future period (Figures \ref{fig:boxplot-land-areaam} and \ref{fig:boxplot-land-coream}). They were also more extensive and had more complex shapes during the simulated historical period as compared to the current landscape, and even more so for the simulated future period compared to the simulated historical period (Figures \ref{fig:boxplot-land-gyrateam} and \ref{fig:boxplot-land-shapeam}). Patches during both simulated periods were more contagious at the cell level than on the current landscape (Figure \ref{fig:boxplot-land-contag}. Finally, patches were much less evenly distributed during the historical period than on the current landscape. However, although the simulated FRV overlaps the simulated HRV for the Simpson's evenness index, medians during the future period are higher than during the historical period (but the current landscape is outside both SRVs) (Figure \ref{fig:boxplot-land-siei}). \todo{I have plots that show the pooled FRV but not sure it adds anything?}
	...
	\begin{figure}[!htbp]
	  ...
	  \subfloat[][]{
	    \centering
	    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/fragland-bymetrics/AREA_AM-boxplots.png}
	    \label{fig:boxplot-land-areaam}
	  }%
	  \qquad
	  \subfloat[][]{
	    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/fragland-bymetrics/CONTAG-boxplots.png}
	    \label{fig:boxplot-land-contag}
	  } \\
	    \subfloat[][]{
	    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/fragland-bymetrics/CORE_AM-boxplots.png}
	    \label{fig:boxplot-land-coream}
	  }%
	  \qquad
	  \subfloat[][]{
	    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/fragland-bymetrics/GYRATE_AM-boxplots.png}
	    \label{fig:boxplot-land-gyrateam}
	  } \\
	    \qquad
	    \subfloat[][]{
	    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/fragland-bymetrics/SHAPE_AM-boxplots.png}
	    \label{fig:boxplot-land-shapeam}
	  }
	  \qquad
	      \subfloat[][]{
	    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/fragland-bymetrics/SIEI-boxplots.png}
...
\section{Seral stage distribution results by seral stage, across all climate trajectories}
...
\begin{figure}[htbp]
  ...
  \subfloat[][]{
    ...
    \qquad
  \subfloat[][]{
    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/covcond-frvhrv/MEGM-frvhrv-boxplots.png}
  }
    \caption{Boxplots illustrating the range of variability across historical and future climate trajectories. The horizontal black bar represents the current condition. Boxplot whiskers extend from the $5^{th}$ to $95^{th}$ range of variability for each model. }
...
\begin{figure}[htbp]
  ...
  \subfloat[][]{
    ...
    \qquad
  \subfloat[][]{
    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/covcond-frvhrv/MEGX-frvhrv-boxplots.png}
  }
    \caption{Boxplots illustrating the range of variability across historical and future climate trajectories. The horizontal black bar represents the current condition. Boxplot whiskers extend from the $5^{th}$ to $95^{th}$ range of variability for each model. }
...
\begin{figure}[htbp]
  ...
  \subfloat[][]{
    ...
    \qquad
  \subfloat[][]{
    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/covcond-frvhrv/OCFW-frvhrv-boxplots.png}
  }
    \caption{Boxplots illustrating the range of variability across historical and future climate trajectories. The horizontal black bar represents the current condition. Boxplot whiskers extend from the $5^{th}$ to $95^{th}$ range of variability for each model. }
...
\begin{figure}[htbp]
  ...
  \subfloat[][]{
    ...
    \qquad
  \subfloat[][]{
    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/covcond-frvhrv/OCFWU-frvhrv-boxplots.png}
  }
    \caption{Boxplots illustrating the range of variability across historical and future climate trajectories. The horizontal black bar represents the current condition. Boxplot whiskers extend from the $5^{th}$ to $95^{th}$ range of variability for each model. }
...
\begin{figure}[htbp]
  ...
  \subfloat[][]{
    ...
    \qquad
  \subfloat[][]{
    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/covcond-frvhrv/RFRM-frvhrv-boxplots.png}
  }
    \caption{Boxplots illustrating the range of variability across historical and future climate trajectories. The horizontal black bar represents the current condition. Boxplot whiskers extend from the $5^{th}$ to $95^{th}$ range of variability for each model. }
...
\begin{figure}[htbp]
  ...
  \subfloat[][]{
    ...
    \qquad
  \subfloat[][]{
    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/covcond-frvhrv/RFRX-frvhrv-boxplots.png}
  }
    \caption{Boxplots illustrating the range of variability across historical and future climate trajectories. The horizontal black bar represents the current condition. Boxplot whiskers extend from the $5^{th}$ to $95^{th}$ range of variability for each model. }
...
\begin{figure}[htbp]
  ...
  \subfloat[][]{
    ...
    \qquad
  \subfloat[][]{
    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/covcond-frvhrv/SMCM-frvhrv-boxplots.png}
  }
    \caption{Boxplots illustrating the range of variability across historical and future climate trajectories. The horizontal black bar represents the current condition. Boxplot whiskers extend from the $5^{th}$ to $95^{th}$ range of variability for each model. }
...
\begin{figure}[htbp]
  ...
  \subfloat[][]{
    ...
    \qquad
  \subfloat[][]{
    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/covcond-frvhrv/SMCU-frvhrv-boxplots.png}
  }
    \caption{Boxplots illustrating the range of variability across historical and future climate trajectories. The horizontal black bar represents the current condition. Boxplot whiskers extend from the $5^{th}$ to $95^{th}$ range of variability for each model. }
...
\begin{figure}[htbp]
  ...
  \subfloat[][]{
    ...
    \qquad 
  \subfloat[][]{
    \includegraphics[width=0.4\textwidth]{/Users/mmallek/Tahoe/Plots/covcond-frvhrv/SMCX-frvhrv-boxplots.png}
  }
    \caption{Boxplots illustrating the range of variability across historical and future climate trajectories. The horizontal black bar represents the current condition. Boxplot whiskers extend from the $5^{th}$ to $95^{th}$ range of variability for each model. }
