...
Mid--Moderate  	 & 1.0      & 1         \\
Late--Closed     & 1.3      & 0.9       \\ 
\emph{Target Fire Rotation}    			& \emph{115 years}  &   \\ 
\bottomrule
\end{tabular}
\end{table}
