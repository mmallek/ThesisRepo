...
The source for the cover layer is the Region 5 Existing Vegetation Map (``EVeg''). Generally, specific cover type names were derived from the California Fire Return Interval Departure (FRID) report by \citet{VandeWater2011}. I also considered information from \emph{A Guide to Wildlife Habitats of California}, popularly known as the ``Wildlife Habitat Relationship'' (WHR) cover types \citep{WHR1988}. 
