...
\begin{quote}
\emph{“In California, vegetation is the meeting place of fire and ecosystems. The plants are the fuel and fire is the driver of vegetation change.”} \todo{cite barbour}\\
\end{quote}
...
The arrival of Europeans in the 1850s sparked a transformation of this landscape as people harvested timber, extracted gold using hydraulic mining techniques, and suppressed wildfires \citep{Storer1963} (Figure~). 
\begin{figure}[!htbp]
  \centering
  \subfloat[][]{
    \centering
...
\begin{figure}[!htbp]
\centering
\includegraphics[height=0.45\textheight]{/Users/mmallek/Documents/Thesis/Plots/ImagefromFireTextbook.pdf}
